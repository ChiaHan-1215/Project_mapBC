...
PATH_TO_FILES=/data/leec20/GWAS_COVNET_related/CARD_COVNET_get_bams/Retrive_regions
...
cat $PATH_TO_FILES/$genomicRegion/fasta_files/*.fa > $PATH_TO_FILES/$genomicRegion/bam_files/CARD_input.fa
...
minimap2 \
	...
	$PATH_TO_FILES/$genomicRegion/bam_files/CARD_input.fa | \
	samtools sort -@ 6 -o $PATH_TO_FILES/$genomicRegion/bam_files/CARD.cb.bam

# Step 3: Index the BAM file
samtools index $PATH_TO_FILES/$genomicRegion/bam_files/CARD.cb.bam

# Step 4: Clean BAM file with only primary alignments
samtools view -F 0x900 -b $PATH_TO_FILES/$genomicRegion/bam_files/CARD.cb.bam > $PATH_TO_FILES/$genomicRegion/bam_files/CARD.cb.primary.bam
samtools index $PATH_TO_FILES/$genomicRegion/bam_files/CARD.cb.primary.bam

# Step 5: remove the temporal FASTA file
rm $PATH_TO_FILES/$genomicRegion/bam_files/CARD_input.fa
